    ...
    return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            ...
                            colors: [
                            Colors.white,
                            Color.fromARGB(255, 184, 229, 255)
                          ]),
                          ...
                          child: Column(
                            children: [
                              Container(
                                width: 80,
                                height: 80,
                                child: Image.asset('assets/Offers/Pay-at-store.png')),
                                SizedBox(height: 25,),
                                Text("Pay using my",style: TextStyle(fontSize: 20),),
                                Text("Balance 500",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                                SizedBox(height: 20,),
                                Padding(
          ...
          width:130.0,
            ...
            Container(
              ...
              }, child: Text("Pay Bill",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 18),)
              )
              )
                            ],
                          ),
